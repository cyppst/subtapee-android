...
import pCordova from 'src/plugins/cordova'

import pAxios from 'src/plugins/axios'

import pImport from 'src/plugins/import'

import pVuelidate from 'src/plugins/vuelidate'

import pVuetimeago from 'src/plugins/vue-timeago'

import pVeevalidate from 'src/plugins/vee-validate'
...
;[pCordova,pAxios,pImport,pVuelidate,pVuetimeago,pVeevalidate].forEach(plugin => {
  plugin({
    app,
    router,
    store,
