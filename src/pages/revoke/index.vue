<template>
    <q-page padding>
        <q-timeline responsive color="secondary">
            ...
            <q-timeline-entry v-for="(revoke, index) in revokes"
                ...
                <q-chip small class="q-mr-xs" color="primary">
                    {{getEquip(revoke.Equipment.brand,revoke.Equipment.model)}}
                </q-chip>
                <q-chip small class="q-mr-xs" color="secondary">
                    S/N : {{revoke.serial.toUpperCase()}}
                </q-chip>
                <q-chip v-if="revoke.service_charge>0" small icon="attach_money" class="q-mr-xs" color="orange-8">
                    {{revoke.service_charge}}
                </q-chip>
            </q-timeline-entry>
        ...
        <!-- content -->
        <!--<q-list highlight>-->
        <!--<q-list-header>ทั้งหมด {{revokes.length}} รายการ</q-list-header>-->
        <!--<q-item>-->
